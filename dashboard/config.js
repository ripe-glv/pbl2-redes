window.DISTRIBUTED_CONFIG = {
  brokers: [
    { id: "broker-a", sensorId: "sensor-a-1", name: "Area 1", label: "Broker A", url: "http://172.16.103.7:8001", x: 18, y: 24 },
  ...
  drones: [
    { id: "drone-base-1", name: "Base 1", droneName: "Drone 1", url: "http://172.16.103.7:9001", x: 24, y: 48 },
